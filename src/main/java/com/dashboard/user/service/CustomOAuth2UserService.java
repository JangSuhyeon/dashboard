...
import com.dashboard.user.domain.dto.OAuthAttributes;
import com.dashboard.user.domain.dto.SessionUser;
import com.dashboard.user.repository.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("new SessionUser(user) : " + new SessionUser(user));
